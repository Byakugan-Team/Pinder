...
export default function LoginScreen({navigation}) {
  ...
  var facebookLogIn = async () => {
    try {
      ...
      if (type === "success") {
        ...
        fetch(
          `https://graph.facebook.com/me?access_token=${token}&fields=id,first_name,last_name,email,picture.height(500)`
        )
  ...
  return (
    <View>
      <Image
        style={styles.Catpeek}
        source={{ uri: "https://i.ibb.co/Hx2QBLc/output-onlinepngtools-2.png" }}
      />
      <Image
        style={styles.logoForm}
        source={{ uri: "https://i.ibb.co/Ttb6xwD/output-onlinepngtools-1.png" }}
      />
      ...
      <View style={styles.Buttons}>
        <TouchableHighlight style={styles.loginBtn} onPress={signInAsync}>
          <View style={styles.cont}>
            <Image
              style={styles.img}
              source={{ uri: "https://img-authors.flaticon.com/google.jpg  " }}
            />
